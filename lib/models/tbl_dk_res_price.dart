...
class TblDkResPrice extends Model {
  ...
  static TblDkResPrice fromMap(Map<String, dynamic> map) => TblDkResPrice(
  ...
  TblDkResPrice copyWith({
    int? ResPriceId,
    int? ResPriceGroupId,
    int? CurrencyId,
    int? ResId,
    String? ResPriceRegNo,
    double? ResPriceValue,
    DateTime? PriceStartDate,
    DateTime? PriceEndDate,
    DateTime? SyncDateTime,
  }) {
    return TblDkResPrice(
      ResPriceId: ResPriceId ?? this.ResPriceId,
      ResPriceGroupId: ResPriceGroupId ?? this.ResPriceGroupId,
      CurrencyId: CurrencyId ?? this.CurrencyId,
      ResId: ResId ?? this.ResId,
      ResPriceRegNo: ResPriceRegNo ?? this.ResPriceRegNo,
      ResPriceValue: ResPriceValue ?? this.ResPriceValue,
      PriceStartDate: PriceStartDate ?? this.PriceStartDate,
      PriceEndDate: PriceEndDate ?? this.PriceEndDate,
